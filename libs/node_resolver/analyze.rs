        ...
        for reexport in reexports {
          let result = self
            .resolve(
              &reexport,
              &referrer,
              // Use import conditions so that dual CJS/ESM packages resolve
              // their ESM build when analyzed as reexports. The CJS wrapper
              // generated by translate_cjs_to_esm uses require() at runtime,
              // but the package graph that the user imports via ESM expects
              // the "import" export condition.
              &[
                Cow::Borrowed("deno"),
                Cow::Borrowed("node"),
                Cow::Borrowed("import"),
